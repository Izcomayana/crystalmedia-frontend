...
// const truncateMarkdown = async (markdown: string, length: number) => {
//   const plainText = await remark().use(strip).process(markdown); // Convert Markdown to plain text
//   return plainText.toString().slice(0, length) + "..."; // Truncate and append ellipsis
// };
...
//         // Generate truncated previews for all blog posts
//         const truncatedPreviews: { [key: string]: string } = {};
//         for (const blog of blogs) {
//           truncatedPreviews[blog.id] = await truncateMarkdown(blog.post, 300);
//         }

//         setPreviews(truncatedPreviews);

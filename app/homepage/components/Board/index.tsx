    ...
    <section>
      <div className="container mx-auto my-20">
        <div className="hidden justify-center items-center text-center flex-col xl:flex">
          <h3 className="font-semibold text-[#00338D] mb-4 text-lg lg:text-2xl">what we do</h3>
        ...
        <div className="xl:flex xl:flex-row-reverse xl:mt-10">
          ...
          <div className="bg-[#00338D] flex justify-center items-center mb-10 p-4 xl:mb-0 xl:px-16 xl:w-[40%]">
